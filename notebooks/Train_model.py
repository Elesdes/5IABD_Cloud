...
# MAGIC - Compare trials in the [MLflow experiment](#mlflow/experiments/2944145529935381).
...
input_data_path = mlflow.artifacts.download_artifacts(run_id="bbde87fa6f0947f1ac23d8294d67db6f", artifact_path="data", dst_path=input_temp_dir)
...
supported_cols = ["Qualité_isolation_menuiseries", "Qualité_isolation_murs", "Hauteur_sous-plafond", "Qualité_isolation_plancher_haut_comble_perdu", "Etiquette_GES", "Qualité_isolation_plancher_bas", "Conso_5_usages/m²_é_finale", "Conso_chauffage_dépensier_installation_chauffage_n°1", "Conso_5_usages_é_finale", "Emission_GES_éclairage", "Type_bâtiment", "Qualité_isolation_enveloppe", "Surface_habitable_logement", "Classe_altitude"]
...
num_imputers = []
num_imputers.append(("impute_mean", SimpleImputer(), ["Conso_5_usages/m²_é_finale", "Conso_5_usages_é_finale", "Conso_chauffage_dépensier_installation_chauffage_n°1", "Emission_GES_éclairage", "Hauteur_sous-plafond", "Surface_habitable_logement"]))
...
numerical_transformers = [("numerical", numerical_pipeline, ["Hauteur_sous-plafond", "Conso_5_usages/m²_é_finale", "Conso_chauffage_dépensier_installation_chauffage_n°1", "Emission_GES_éclairage", "Surface_habitable_logement", "Conso_5_usages_é_finale"])]
...
categorical_one_hot_transformers = [("onehot", one_hot_pipeline, ["Classe_altitude", "Etiquette_GES", "Qualité_isolation_enveloppe", "Qualité_isolation_menuiseries", "Qualité_isolation_murs", "Qualité_isolation_plancher_bas", "Qualité_isolation_plancher_haut_comble_perdu", "Type_bâtiment"])]
...
# MAGIC - All the runs are logged under [this MLflow experiment](#mlflow/experiments/2944145529935381)
...
def objective(params):
  with mlflow.start_run(experiment_id="2944145529935381") as mlflow_run:
...
space = {
  "colsample_bytree": 0.4592666800447351,
  "lambda_l1": 0.11296463898623076,
  "lambda_l2": 0.3245107404897657,
  "learning_rate": 0.04567815604516338,
  "max_bin": 221,
  "max_depth": 6,
  "min_child_samples": 139,
  "n_estimators": 749,
  "num_leaves": 294,
  "path_smooth": 90.61615223447056,
  "subsample": 0.7193708172233283,
  "random_state": 155219335,
}
...
if shap_enabled:
    ...
    train_sample = X_train.sample(n=min(100, X_train.shape[0]), random_state=155219335).fillna(mode)

    # Sample some rows from the validation set to explain. Increase the sample size for more thorough results.
    example = X_val.sample(n=min(100, X_val.shape[0]), random_state=155219335).fillna(mode)
...
displayHTML(f"<a href=#mlflow/experiments/2944145529935381/runs/{ mlflow_run.info.run_id }/artifactPath/model> Link to model run page </a>")
